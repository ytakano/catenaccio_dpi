...
-->
  ...
  <body>
    ...
    <div class="content">
      <p>
        <a href="/data/%(digest)s/http_full_graph.dot">download Graphviz dot file</a>
      </p>
      <p>
        <a href="/data/%(digest)s/http_full_graph.sif">download SIF file</a>
      </p>
    </div>
  </body>
</html>
"""
    ...
    def print_html(self):
        ...
        for ip in self._ip:
            ...
            open(os.path.join(dname, 'http_stats.html'),'w').write(html)
